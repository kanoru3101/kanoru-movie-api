...
export class AddTvEpisodeTable1689090138023 implements MigrationInterface {
    name = 'AddTvEpisodeTable1689090138023'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tv_episode" ("id" SERIAL NOT NULL, "tmdb_id" integer NOT NULL, "language" character varying NOT NULL, "name" character varying, "overview" character varying, "poster_path" character varying, "season_number" integer NOT NULL DEFAULT '0', "vote_average" real NOT NULL, "vote_count" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "tvSeasonId" integer, CONSTRAINT "UQ_4b3c28e85a33e27933e30fb2245" UNIQUE ("language", "tmdb_id"), CONSTRAINT "PK_930dde0fcfc177e438e41ef7d70" PRIMARY KEY ("id"))`);
